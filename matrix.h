/* Imported via http://arkanis.de/projects#2016-02-math-3d */
...
static inline MM_UNUSED
vec3_t vec3(float x, float y, float z)        { return (vec3_t){ x, y, z }; }



static inline MM_UNUSED
vec3_t v3_add   (vec3_t a, vec3_t b)          { return (vec3_t){ a.x + b.x, a.y + b.y, a.z + b.z }; }
static inline MM_UNUSED
vec3_t v3_adds  (vec3_t a, float s)           { return (vec3_t){ a.x + s,   a.y + s,   a.z + s   }; }
static inline MM_UNUSED
vec3_t v3_sub   (vec3_t a, vec3_t b)          { return (vec3_t){ a.x - b.x, a.y - b.y, a.z - b.z }; }
static inline MM_UNUSED
vec3_t v3_subs  (vec3_t a, float s)           { return (vec3_t){ a.x - s,   a.y - s,   a.z - s   }; }
static inline MM_UNUSED
vec3_t v3_mul   (vec3_t a, vec3_t b)          { return (vec3_t){ a.x * b.x, a.y * b.y, a.z * b.z }; }
static inline MM_UNUSED
vec3_t v3_muls  (vec3_t a, float s)           { return (vec3_t){ a.x * s,   a.y * s,   a.z * s   }; }
static inline MM_UNUSED
vec3_t v3_div   (vec3_t a, vec3_t b)          { return (vec3_t){ a.x / b.x, a.y / b.y, a.z / b.z }; }
static inline MM_UNUSED
vec3_t v3_divs  (vec3_t a, float s)           { return (vec3_t){ a.x / s,   a.y / s,   a.z / s   }; }
static inline MM_UNUSED
float  v3_length(vec3_t v)                    { return sqrtf(v.x*v.x + v.y*v.y + v.z*v.z);          }
static inline MM_UNUSED
vec3_t v3_norm  (vec3_t v);
static inline MM_UNUSED
float  v3_dot   (vec3_t a, vec3_t b)          { return a.x*b.x + a.y*b.y + a.z*b.z;                 }
static inline MM_UNUSED
vec3_t v3_proj  (vec3_t v, vec3_t onto);
static inline MM_UNUSED
...
static inline MM_UNUSED
vec4_t vec4(float x, float y, float z, float w){ return (vec4_t){ x, y, z, w }; }

typedef struct { uint8_t x, y; } bvec2_t;
static inline MM_UNUSED
bvec2_t bvec2(uint8_t x, uint8_t y)            { return (bvec2_t){ x, y }; }

typedef struct { uint8_t x, y, z; } bvec3_t;
static inline MM_UNUSED
bvec3_t bvec3(uint8_t x, uint8_t y, uint8_t z) { return (bvec3_t){ x, y, z }; }

typedef struct { uint8_t x, y, z, w; } bvec4_t;
static inline MM_UNUSED
bvec4_t bvec4(uint8_t x, uint8_t y, uint8_t z, uint8_t w)
                                               { return (bvec4_t){ x, y, z, w }; }
...
static inline MM_UNUSED
ivec3_t ivec3(int x, int y, int z)             { return (ivec3_t){ x, y, z }; }

typedef struct { int x, y, z, w; } ivec4_t;
static inline MM_UNUSED
ivec4_t ivec4(int x, int y, int z, int w)      { return (ivec4_t){ x, y, z, w }; }
...
static inline MM_UNUSED
mat4_t m4_rotation_y   (float angle_in_rad);
static inline MM_UNUSED
...
static inline MM_UNUSED
mat4_t m4_transpose    (mat4_t matrix);
static inline MM_UNUSED
